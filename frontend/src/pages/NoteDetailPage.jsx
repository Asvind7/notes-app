...
const handleSave = async() =>{
  if(!note.title.trim() || !note.content.trim()){
    toast.error("please add a title or cntent")
    return
  }
  setSaving(true)
  try {
    ...
    <div className='min-h-screen bg-base-200'>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className='flex items-center justify-between mb-6'>
         ...
         <button onClick={handleDelete} className='btn btn-ghost btn-s text-error border-error hover:text-white hover:bg-error transition-all duration-200' >
              <Trash2Icon className='size-4 ' />   
              Delete note  
         </button>
         </div>

         <div className="card bg-base-100 p-1">
